...
{	//Sends the sample to the shader
	...
	if (is_undefined(sample) || !is_array(sample))
	{
...
function sample_get_node_dq(rig, nodeInd, sample, targetQ) 
{	/*	
	...
	*/
	var tempQ = is_undefined(targetQ) ? array_create(8) : targetQ;
...
function sample_get_node_matrix(rig, nodeInd, sample, targetM) 
{	/*
	...
	*/
	...
	return smf_mat_create_from_dualquat(tempQ, (is_undefined(targetM)) ? array_create(16) : targetM);
}
